...
// 1. Buscar todos os moradores para o dropdown
$moradores = [];
try {
...
// 2. Tratar o POST (Cadastro da Ocorrência)
if($_SERVER['REQUEST_METHOD'] == "POST"){
    $titulo = $_POST['titulo'];
    $descricao = $_POST['descricao'];
    $id_morador = $_POST['id_morador'];
    // A data_hora NÃO é enviada, usamos NOW()
    ...
    if (empty($titulo) || empty($descricao) || empty($id_morador)) {
        ...
        try{
            // Usamos a função NOW() do MySQL para inserir a data e hora atuais
