...
if($_SERVER['REQUEST_METHOD'] == "GET"){
    try{
        ...
        // Busca TODAS as unidades para o dropdown
...
// 2. POST: Atualizar o morador no banco
if($_SERVER['REQUEST_METHOD'] == "POST"){
    $nome = $_POST['nome'];
    $id_unidade = $_POST['id_unidade'];
    $id_morador = $_POST['id_morador']; // Vem do input hidden
                            ...
                            <div class="mb-3">
                                ...
                                <select id="id_unidade" name="id_unidade" class="form-select" required>
                                    ...
                                    <?php foreach ($unidades as $unidade): ?>
                                        <?php 
                                            // Lógica para pré-selecionar a unidade atual do morador
