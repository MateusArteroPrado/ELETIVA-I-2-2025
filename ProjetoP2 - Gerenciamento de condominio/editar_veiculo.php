...
// 1. GET: Buscar dados do veículo E a lista de moradores
...
// 2. POST: Atualizar o veículo no banco
if($_SERVER['REQUEST_METHOD'] == "POST"){
    $placa = $_POST['placa']; // Vem do input (readonly)
    $modelo = $_POST['modelo'];
    $cor = $_POST['cor'];
                            ...
                            <div class="mb-3">
                                ...
                                <select id="id_morador" name="id_morador" class="form-select" required>
                                    ...
                                    <?php foreach ($moradores as $morador): ?>
                                        <?php 
                                            // Lógica para pré-selecionar o proprietário atual
